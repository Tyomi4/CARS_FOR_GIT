...
class AutoCatalog:
    ...
    def search_car(self):
        ...
        if not lines[1:]:
            return 'Ошибка : В базе нет машин!'
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print('Введите "Новый параметр" чтобы добавить новый параметр')
        print('Введите "Удалить параметр" чтобы удалить существующий параметр')
        ...
        elif command.lower() == 'новый параметр':
            auto_catalog.add_new_parameter()
        elif command.lower() == 'удалить параметр':
            auto_catalog.del_current_parameter()
